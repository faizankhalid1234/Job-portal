...
const Home = () => {
  // Sample random jobs data (6-7 jobs)
  const jobs = [
    {
      id: 1,
  ...
  const prevJob = () => {
    setCurrentJobIndex((prevIndex) => (prevIndex - 1 + jobs.length) % jobs.length);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto mb-12">
            ...
            {/* Jobs Navigation Section - Moved here, right below Search Jobs */}
            <div className="mt-8 bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto">
              {/* Navigation Arrows - Made smaller and cuter */}
